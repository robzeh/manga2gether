defmodule Manga2getherWeb.Router do
  use Manga2getherWeb, :router

  import Manga2getherWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, {Manga2getherWeb.LayoutView, :root}
  ...
  if Mix.env() in [:dev, :test] do
    ...
    scope "/" do
      ...
      live_dashboard "/dashboard", metrics: Manga2getherWeb.Telemetry
    end
  end
